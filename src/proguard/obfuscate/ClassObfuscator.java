             ...
             ConstantVisitor
{
    ...
    public void visitProgramClass(ProgramClass programClass)
    {
        ...
        String className=programClass.getName();		//added by Soham Ghosh
        if (newClassName == null)
        {
            ...
            newClassName = newClassName != null && numericClassName ?
                generateUniqueNumericClassName(newPackagePrefix) :
                generateUniqueClassName(newPackagePrefix,className);		//added by Soham Ghosh
    ...
    private String newPackagePrefix(String packagePrefix)
    {
        ...
        //System.out.println("sub: "+packagePrefix);
        if (newPackagePrefix == null)
        {
            ...
            //System.out.println("SUPER: "+newSuperPackagePrefix);
            // Come up with a new package prefix.
            //newPackagePrefix = generateUniquePackagePrefix(newSuperPackagePrefix);
            newPackagePrefix = generateUniquePackagePrefix(newSuperPackagePrefix,packagePrefix);		//added by Soham Ghosh
    ...
    private String generateUniquePackagePrefix(String newSuperPackagePrefix)
    {
        ...
        if (packageNameFactory == null)
        {
            ...
            packageNameFactory = new RandomNameFactory();
     ...
     * Creates a new package prefix in the given new superpackage.
     */
    private String generateUniquePackagePrefix(String newSuperPackagePrefix, String packagePrefix)
    {
        // Find the right name factory for this package.
        NameFactory packageNameFactory =
            (NameFactory)packagePrefixPackageNameFactoryMap.get(newSuperPackagePrefix);
        ...
        return generateUniquePackagePrefix(newSuperPackagePrefix, packagePrefix, packageNameFactory);
    }
     ...
     */
    private String generateUniquePackagePrefix(String      newSuperPackagePrefix, String packagePrefix,	
                                               NameFactory packageNameFactory)		//added by Soham Ghosh
    {
        // Come up with package names until we get an original one.
        String newPackagePrefix;
        do
        {
            // Let the factory produce a package name.
        	//System.out.println("Super: "+newSuperPackagePrefix);
        	//System.out.println("Current: "+packagePrefix);
            newPackagePrefix = newSuperPackagePrefix +
                               packageNameFactory.nextName(packagePrefix) +
                               ClassConstants.INTERNAL_PACKAGE_SEPARATOR;
            System.out.println("Generating Package Prefix for "+"superpackage "+newSuperPackagePrefix+" & package prefix "+packagePrefix+" : "+newPackagePrefix);
        }
        while (packagePrefixMap.containsValue(newPackagePrefix));
    ...
    private String generateUniqueClassName(String newPackagePrefix)
    {
        ...
        if (classNameFactory == null)
        {
            ...
            classNameFactory = new RandomNameFactory();
    ...
    private String generateUniqueClassName(String newPackagePrefix, String className)		//added by Soham Ghosh
    {
        // Find the right name factory for this package.
        NameFactory classNameFactory =
            (NameFactory)packagePrefixClassNameFactoryMap.get(newPackagePrefix);
        ...
        return generateUniqueClassName(newPackagePrefix, classNameFactory, className);
    }
    ...
    private String generateUniqueClassName(String      newPackagePrefix,
    		NameFactory classNameFactory, String className)
    {
    	// Come up with class names until we get an original one.
    	String newClassName;
    	String newMixedCaseClassName;
    	do
    	{
    		// Let the factory produce a class name.
    		newClassName = newPackagePrefix +
    				classNameFactory.nextName(className);
    		System.out.println("New Package Prefix for "+className+" : "+newPackagePrefix);
    		System.out.println("Generating classname for "+className+" : "+newClassName);
    		newMixedCaseClassName = mixedCaseClassName(newClassName);
    	}
    	while (classNamesToAvoid.contains(newMixedCaseClassName));
