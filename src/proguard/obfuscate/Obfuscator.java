...
public class Obfuscator
{
    ...
    private static ArrayList<String> innerclass = new ArrayList<String>();		//Added by Soham Ghosh
                        ...
                        ClassPool libraryClassPool) throws IOException
    {
        ...
        System.out.println("Size: "+libraryClassPool.size());
        System.out.println("Size: "+SimpleLibraryClasses.size());
        Iterator<String> iter = SimpleLibraryClasses.simpleClasses();
        while (iter.hasNext()) {
			String markedClass = (String) iter.next();
			System.out.println("Marked library class: "+markedClass);
		}
        ...
        //NameFactory nameFactory = new SimpleNameFactory(configuration.useMixedCaseClassNames);
        NameFactory nameFactory = new RandomNameFactory();
        ...
        {
        	System.out.println("Using UniqueClassMemberNames");
        ...
        Iterator iterator=programClassPool.classNames();
        while(iterator.hasNext()){
        	String className=(String)iterator.next();;
        	int indx=className.indexOf('$');
        	if(indx!=-1){
        		innerclass.add(className);
        		innerclass.add(className.substring(0,indx));
        		//System.out.println(className.substring(0,indx)+", "+className);
        	}
        }
    ...
    public static boolean innerclassContains(String str){
    	return innerclass.contains(str);
    }
}
