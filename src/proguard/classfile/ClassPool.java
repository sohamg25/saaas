...
public class ClassPool
{
    ...
    /*
     * Method to fetch simple classnames from cannonical classnames of Clazz.
     */
    public String getSimpleName(String cannonicalName){
    	return cannonicalName.substring(cannonicalName.lastIndexOf('/')+1);
    }
    ...
    public void addClass(Clazz clazz)
    {
        ...
        SimpleLibraryClasses.addClass(getSimpleName(clazz.getName()));
    }
    ...
    public void removeClass(String className)
    {
        ...
        SimpleLibraryClasses.removeClass(getSimpleName(className));
    }
    ...
    public void classesAccept(ClassVisitor classVisitor)
    {
        ...
        while (iterator.hasNext())
        {
            ...
            System.out.println("unique: "+clazz.getName());
