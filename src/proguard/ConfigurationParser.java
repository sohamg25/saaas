...
public class ConfigurationParser
{
    ...
    throws ParseException, IOException
    {
        while (nextWord != null)
        {
            ...
            else if (ConfigurationConstants.FORCE_UNIQUE_CLASS_MEMBER_NAMES_OPTION           .startsWith(nextWord)) Configuration.forceUniqueClassMemberNames      = parseNoArgument(true);
